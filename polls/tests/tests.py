...
class QuestionModelTests(TestCase):
    ...
    def test_future_pub_date(self):
        """
        is_published() should return False for
        questions with a future pub_date.
        """
    ...
    def test_default_pub_date(self):
        """
        is_published() should return True for
        questions with the default pub_date (now).
        """
        now = timezone.now()
    ...
    def test_can_vote_with_no_end_date(self):
        ...
        past_pub_date = timezone.now() - timezone.timedelta(days=1)
        no_end_date = None
        no_end_question = Question(pub_date=past_pub_date,
    ...
    def test_can_vote_with_end_date_in_future(self):
        ...
        future_question = Question(pub_date=past_pub_date,
    ...
    def test_can_vote_with_end_date_and_time_equal_to_now(self):
        ...
        # now + 1 second(baease on the time of the test deley when we run code)
        now_question = Question(pub_date=past_pub_date,
                                end_date=now)
